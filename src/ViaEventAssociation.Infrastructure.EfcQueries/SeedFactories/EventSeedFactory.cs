...
{
    public static List<DTOs.Event> CreateEvents(string creatorId)
    {
	    var tmpEvents = JsonSerializer.Deserialize<List<TmpEvent>>(EventsJson);
      var events = tmpEvents!.Select(e=> new DTOs.Event
      {
          CreatorId = creatorId,
          ...
          VeaEventStatus = e.Status,
          VeaEventType = e.Visibility,
          From = e.Start,
          To = e.End,
