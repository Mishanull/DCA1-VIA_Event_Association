...
public class DispatcherInteractionTest
{
    ...
    public async void Dispatch_WithOneIncorrectHandlerRegistered_ShouldNotInvokeHandler()
    {
        ...
        serviceCollection = serviceCollection.AddCommandHandlers(Assembly.GetAssembly(typeof(EmptyMockHandler))!);
    ...
    public async void Dispatch_WithEmptyHandlerRegistered_ShouldThrow()
    {
        ...
        serviceCollection = serviceCollection.AddCommandHandlers(Assembly.GetAssembly(typeof(ICommandHandler<>))!);
        IServiceProvider serviceProvider = serviceCollection.BuildServiceProvider();
    ...
    public async void Dispatch_WithOneCorrectHandlerRegistered_ShouldInvokeHandler()
    {
        // Arrange
        IServiceCollection serviceCollection = new ServiceCollection();
        serviceCollection = serviceCollection.AddCommandHandlers(Assembly.GetAssembly(typeof(CreateEventMockHandler))!);
        IServiceProvider serviceProvider = serviceCollection.BuildServiceProvider();
